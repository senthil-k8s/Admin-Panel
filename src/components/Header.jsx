...
const Header = () => {
    ...
    return (
        <div>
            <div className="fixed w-full flex items-center justify-between h-14 text-white z-10 top-4">
